...
public class UIManager : MonoBehaviour
{
    ...
    public void OpenReloadButtonUI()
    {
        foreach (var button in _reloadButtons)
        {
            ...
            float randomX = Random.Range(_reloadButtonRandomSpawnWindow.bounds.min.x, _reloadButtonRandomSpawnWindow.bounds.max.x);
            float randomY = Random.Range(_reloadButtonRandomSpawnWindow.bounds.min.y, _reloadButtonRandomSpawnWindow.bounds.max.y);
